<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/index\view\product\index.html";i:1524126849;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\header.html";i:1523497482;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\footer.html";i:1522738331;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="container" id="product">
	...
	<form class="form-horizontal" id="form"  action="<?php echo url('index/search/index'); ?>" method="get">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <label for="" class="col-md-3 control-label">请输入产品名称</label>
                            <div class="col-md-6">
                                <input type="text" name="product_title"  class="form-control" placeholder="请输入产品名称">
                            </div>
                            <div class="col-md-1">
    		...
    		<div class="thumbnail">
      			...
      			<div class="caption">
        			<h3 class="text-center"><?php echo $vo['product_title']; ?></h3>
        				<p><a href="<?php echo url('index/productdetail/index',['product_id'=>$vo['product_id']]); ?>" class="btn btn-primary glyphicon glyphicon-search custom-xiangqing" role="button">
                <span>产品详情</span></a></p>
      			</div>
    		</div>
  		</div>
