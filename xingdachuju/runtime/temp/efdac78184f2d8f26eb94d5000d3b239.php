<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/admin\view\chengnuo\index.html";i:1522661367;s:70:"D:\xampp\htdocs\dashboard\xingdachuju\application\admin\view\base.html";i:1523328949;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<ul class="nav nav-tabs" role="tablist">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td><?php echo $vo['chengnuo_id']; ?></td>
                                <td><?php echo $vo['chengnuo_name']; ?></td>
                                <td><?php echo $vo['chengnuo_value']; ?></td>
                                <td>
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" class="btn btn-primary btn-xs dropdown-toggle">操作 <span class="caret"></span></button>
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo url('admin/chengnuo/store',['chengnuo_id'=>$vo['chengnuo_id']]); ?>">编辑</a></li>
                                            <li class="divider"></li>
                                            <li><a href="javascript:;" onclick="del(<?php echo $vo['chengnuo_id']; ?>)">删除</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
            ...
            <script type="text/javascript">
                function del(chengnuo_id){
                    location.href="<?php echo url('del'); ?>"+'?chengnuo_id='+chengnuo_id;
                }
            </script>
