<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/index\view\news\index.html";i:1523513628;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\header.html";i:1523497482;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\footer.html";i:1522738331;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<title><?php echo $_cateData1['d']; ?></title>
<!--描述和摘要-->
...
<div class="container" id="news">
	<div class="row custom-wen">
		<div class="custom-xin">
		    <div class="col-md-4 hidden-xs custom-date">
			  <div class="custom-riqi">
				<p class="custom-day"><?php echo $vo['new_date']; ?></p>
				<p class="custom-year">日期</p>
			  </div>
		    </div>
		  <div class="col-md-8 custom-xinwen">
			<h3><?php echo $vo['new_title']; ?></h3>
			<p class="hidden-xs hidden-sm" style="color:#ACACAC;"><?php echo $vo['new_digest']; ?></p>
			<a href="<?php echo url('index/newsdetail/index',['new_id'=>$vo['new_id']]); ?>" class="btn btn-success">查看详情</a>
		  </div>
	    </div>
    </div>
</div>
