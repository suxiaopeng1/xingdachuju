<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/admin\view\webset\index.html";i:1517018466;s:70:"D:\xampp\htdocs\dashboard\xingdachuju\application\admin\view\base.html";i:1523328949;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<ul class="nav nav-tabs" role="tablist">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control" value="<?php echo $vo['webset_value']; ?>"
                                     onblur="change(this,<?php echo $vo['webset_id']; ?>)">
                                </td>
            ...
            <script type="text/javascript">
            	...
            	function change(obj,webset_id){
            		...
            		$.post("<?php echo url('edit'); ?>",{webset_id:webset_id,webset_value:webset_value},
            			function(res){
