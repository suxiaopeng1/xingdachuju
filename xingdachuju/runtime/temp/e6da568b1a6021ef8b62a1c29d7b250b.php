<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/index\view\search\index.html";i:1523583496;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\header.html";i:1523497482;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\footer.html";i:1522738331;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
	...
	<form class="form-horizontal" id="form"  action="" method="post" enctype="multipart/form-data">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">产品检索</h3>
                    </div>
                </div>
            </form>
	<div class="row">
		<div>搜索<font style="color:red; margin:0 5px;"><?php echo $product_title; ?></font>的结果：</div><div class="clear"></div>
	</div>

	<div class="row">
    <?php if($product_title != ''): if(is_array($serRes) || $serRes instanceof \think\Collection || $serRes instanceof \think\Paginator): $i = 0; $__LIST__ = $serRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
  		<div class="col-sm-6 col-md-4">
    		<div class="thumbnail">
      			<img src="/dashboard/xingdachuju/public/uploads/<?php echo $vo['product_thumb']; ?>" alt="..." aos="zoom-in">
      			<div class="caption">
        			<h3 class="text-center"><?php echo $vo['product_title']; ?></h3>
        				<p><a href="<?php echo url('index/productdetail/index',['product_id'=>$vo['product_id']]); ?>" 
                  class="btn btn-primary glyphicon glyphicon-search custom-xiangqing" role="button">产品详情</a></p>
      			</div>
    		</div>
  		</div>
