<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/admin\view\news\index.html";i:1523261310;s:70:"D:\xampp\htdocs\dashboard\xingdachuju\application\admin\view\base.html";i:1523328949;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
 ...
 <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="#tab1">新闻管理</a></li>
                <li><a href="<?php echo url('store'); ?>">添加新闻</a></li>
            </ul>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $vo['new_title']; ?></td>
                                    <td><?php echo $vo['new_date']; ?></td>
                                    <td>
                                        <div class="btn-group">
                                            <button data-toggle="dropdown" class="btn btn-primary btn-xs dropdown-toggle">操作 <span class="caret"></span></button>
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="<?php echo url('edit',['new_id'=>$vo['new_id']]); ?>">编辑</a></li>
                                                <li class="divider"></li>
                                                <li><a href="<?php echo url('delToRecycle',['new_id'=>$vo['new_id']]); ?>">删除到回收站</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
