<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/index\view\company\index.html";i:1523238518;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\header.html";i:1523497482;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\footer.html";i:1522738331;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<title><?php echo $_cateData1['h']; ?></title>
<!--描述和摘要-->
...
<div class="container" id="custom-gongsi">
	<div class="row custom-timu">
		<h3 class="text-center">……公司简介……</h3>
	</div>
	<div class="row custom-content">
		<div class="col-md-4 custom-tupian">
			<img src="/dashboard/xingdachuju/public/static/index/images/xd.jpg" class="img-responsive">
		</div>
		<div class="col-md-4 hidden-xs hidden-sm custom-biankuang">

		</div>
		<div class="col-md-4 custom-wenzi">
			<p><?php echo $_qiye['a']; ?></p>
		</div>
	</div>
	<div class="container" id="custom-jieshao">
		<h3><?php echo $_qiye['b']; ?></h3>
		<p aos="fade-up"><?php echo $_qiye['c']; ?></p>
		<p aos="fade-up"><?php echo $_qiye['d']; ?></p>
		<p aos="fade-up"><?php echo $_qiye['e']; ?></p>
		<p aos="fade-up"><?php echo $_qiye['f']; ?></p>
		<p aos="fade-up"><?php echo $_qiye['g']; ?></p>
	</div>
