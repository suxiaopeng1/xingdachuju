<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/index\view\newsdetail\index.html";i:1523238571;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\header.html";i:1523497482;s:72:"D:\xampp\htdocs\dashboard\xingdachuju\application\index\view\footer.html";i:1522738331;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="container" id="news_detail">
	<div class="row">
	 <h1 class="text-center"><?php echo $newsData['new_title']; ?></h1>
	</div>
	<div class="row">
	 <h3 class="text-center"><span class="custom-shijian">日期：<?php echo $newsData['new_date']; ?></span></h3>
	</div>
	<p><?php echo $newsData['new_content']; ?></p>
</div>
