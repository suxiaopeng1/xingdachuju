<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\xampp\htdocs\dashboard\xingdachuju\public/../application/admin\view\seo\index.html";i:1523237371;s:70:"D:\xampp\htdocs\dashboard\xingdachuju\application\admin\view\base.html";i:1523328949;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="#tab1">SEO优化</a></li>
            </ul>
                    ...
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo $vo['seo_name']; ?></td>
                                <td>
                                    <input type="text" class="form-control" value="<?php echo $vo['seo_value']; ?>"
                                     onblur="change(this,<?php echo $vo['seo_id']; ?>)">
                                </td>
                                <td><?php echo $vo['seo_des']; ?></td>
                            </tr>
            ...
            <script type="text/javascript">
            	...
            	function change(obj,seo_id){

            		//获取配置值
            		var seo_value=$(obj).val();
            		$.post("<?php echo url('edit'); ?>",{seo_id:seo_id,seo_value:seo_value},
            			function(res){
